...
from keras.layers import Dense, Embedding, LSTM, CuDNNLSTM, SpatialDropout1D, Input, Bidirectional, Dropout, \
    BatchNormalization, Lambda, concatenate, Flatten, Reshape, Conv1D, MaxPooling1D, CuDNNGRU
...
#
#            A     0.7843    0.6154    0.6897       130
#            B     0.6835    0.8308    0.7500       130
#
#    micro avg     0.7231    0.7231    0.7231       260
#    macro avg     0.7339    0.7231    0.7198       260
# weighted avg     0.7339    0.7231    0.7198       260
...
leftdense = Dense(Hidden, activation='relu', kernel_regularizer=regularizers.l2(Regularization))(dropout)
batchNorm = BatchNormalization()(leftdense)
...
middleDense = Dense(Hidden, activation='relu', kernel_regularizer=regularizers.l2(Regularization))(bgru)
middleDense = Dense(Hidden, activation='relu', kernel_regularizer=regularizers.l2(Regularization))(middleDense)
middleDense = Dense(Hidden, activation='relu', kernel_regularizer=regularizers.l2(Regularization))(middleDense)
middleDense = Dense(Hidden, activation='relu', kernel_regularizer=regularizers.l2(Regularization))(middleDense)
batchNormb = BatchNormalization()(middleDense)
...
flattenc = Flatten()(batchNormc)
concat = concatenate([batchNorm, batchNormb, flattenc])
