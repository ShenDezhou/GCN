...
from keras.layers import Dense, Embedding, LSTM, CuDNNLSTM, SpatialDropout1D, Input, Bidirectional, Dropout, \
    BatchNormalization, Lambda, concatenate, Flatten, Reshape
...
#
#            A     0.6974    0.4077    0.5146       130
#            B     0.5815    0.8231    0.6815       130
#
#    micro avg     0.6154    0.6154    0.6154       260
#    macro avg     0.6394    0.6154    0.5980       260
# weighted avg     0.6394    0.6154    0.5980       260
...
blstmc = Bidirectional(CuDNNLSTM(Hidden, return_sequences=False), merge_mode='sum')(dropoutc)
