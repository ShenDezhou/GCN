...
#
#            A     0.7900    0.6077    0.6870       130
#            B     0.6813    0.8385    0.7517       130
#
#    micro avg     0.7231    0.7231    0.7231       260
#    macro avg     0.7356    0.7231    0.7193       260
# weighted avg     0.7356    0.7231    0.7193       260
...
blstmd = Bidirectional(CuDNNGRU(Hidden, return_sequences=False), merge_mode='sum')(dropoutd)
