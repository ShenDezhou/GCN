...
#
#            A     0.5738    0.2692    0.3665       130
#            B     0.5226    0.8000    0.6322       130
#
#    micro avg     0.5346    0.5346    0.5346       260
#    macro avg     0.5482    0.5346    0.4994       260
# weighted avg     0.5482    0.5346    0.4994       260
...
blstm = Bidirectional(CuDNNLSTM(Hidden, batch_input_shape=(seqlen, word_size+actors_size), return_sequences=False), merge_mode='sum')(dropout)
