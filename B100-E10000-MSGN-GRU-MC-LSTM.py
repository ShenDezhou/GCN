...
#
#            A     0.6450    0.8385    0.7291       130
#            B     0.7692    0.5385    0.6335       130
#
#    micro avg     0.6885    0.6885    0.6885       260
#    macro avg     0.7071    0.6885    0.6813       260
# weighted avg     0.7071    0.6885    0.6813       260
...
seqsd = Lambda(lambda x: x[:,  5:])(sequence)
...
dropoutd = SpatialDropout1D(rate=Dropoutrate)(embeddedc)
blstmd = Bidirectional(CuDNNLSTM(Hidden, return_sequences=False), merge_mode='sum')(dropoutd)
batchNormd = BatchNormalization()(blstmd)

concat = concatenate([batchNorm, batchNormb, flatten, batchNormd])
