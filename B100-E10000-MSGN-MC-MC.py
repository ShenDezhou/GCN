...
from keras.layers import Dense, Embedding, LSTM, CuDNNLSTM, SpatialDropout1D, Input, Bidirectional, Dropout, \
    BatchNormalization, Lambda, concatenate, Flatten, Reshape, Conv1D, MaxPooling1D
...
#
#            A     0.7788    0.6231    0.6923       130
#            B     0.6859    0.8231    0.7483       130
#
#    micro avg     0.7231    0.7231    0.7231       260
#    macro avg     0.7324    0.7231    0.7203       260
# weighted avg     0.7324    0.7231    0.7203       260
...
conv = Conv1D(filters=nfilters, kernel_size=kernelSize)(dropoutb)
...
batchNormb = BatchNormalization()(mpool)
flattenb = Flatten()(batchNormb)
...
concat = concatenate([batchNorm, flattenb, flatten])
