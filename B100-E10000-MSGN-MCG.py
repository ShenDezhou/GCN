...
#
#            A     0.7647    0.6000    0.6724       130
#            B     0.6709    0.8154    0.7361       130
#
#    micro avg     0.7077    0.7077    0.7077       260
#    macro avg     0.7178    0.7077    0.7043       260
# weighted avg     0.7178    0.7077    0.7043       260
...
bgru = Bidirectional(CuDNNGRU(Hidden, return_sequences=False), merge_mode='sum')(mpool)

# blstmc = Bidirectional(CuDNNLSTM(Hidden, return_sequences=False), merge_mode='sum')(bgru)
batchNormc = BatchNormalization()(bgru)
